...
uint8_t mSensorsAddress[NUM_OF_ALL_SENSORS][8] =   // LSB on the left, transmit LSB first!!
{
		...
		{0x28,  0x4C,  0xA3,  0x7E,  0x0C,  0x00, 0x00,  0x6D},                      //T_IOBOARD_U
		{0x28,  0x60,  0x99,  0x7E,  0x0C,  0x00, 0x00,  0x9F},                      //T_TECHM
		{0x28,  0x4D,  0xA3,  0x7E,  0x0C,  0x00, 0x00,  0x5A},                      //T_IOBOARD_D
		{0x28,  0x56,  0x99,  0x7E,  0x0C,  0x00, 0x00,  0xC0},                      //T_ELECON
